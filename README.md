...
2. Класс Page происхоидт от класса Component и представляет собой визуальную реализацию главной страницы приложения. Имеет следующие поля:
...
3. Класс ItemCard наследует Component и представляет себя визуальную реализацию индивидульной карточки товара. Имеет следующие поля:
