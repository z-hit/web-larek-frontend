...
Класс `ItemCard<T>` наследует от класса Component и представляет себя визуальную реализацию индивидульной карточки товара. Это дженерик класс, приниающий определенный тип данных T. Имеет следующие поля:
